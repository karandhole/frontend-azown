...
const Rflate = ({property, onAlert}) => {
  ...
  const { lead, handlereq,rfmDetail,rfmdata } = context;
        ...
        {data.hasOwnProperty('phone')? <strong>Phone No. : {data.phone}</strong> : <strong>Email: {data.email}</strong>}
          ...
          <div className="list_view_flex">										
            ...
            <div style={{borderTop: '#dddddd solid', borderBottom: '#dddddd solid', paddingBottom: 10}}>
              ...
              <div className="_card_list_flex mb-2">
                <p style={{lineHeight:'1'}}><i className="lni-map-marker" />{property.rfm_location_city}</p>
              </div>											
            ...
            <div className="listing-detail-footer" style={{marginTop: 0, paddingRight: 0}}>
              ...
              {localStorage.getItem('userDetail') ? property.like && property.like.includes(userId) || liked ? <span  >  <i className=" fa fa-heart" style={{fontSize: 35,color:"red", paddingRight: 22, paddingTop: 5 , cursor:"pointer"}} /></span> :<span onClick={()=>{setliked(true);likeprop(property._id,4)}} >  <i className=" fa fa-heart" style={{fontSize: 35,color:`${ !liked ? "#27ae60":"red"}`, paddingRight: 22, paddingTop: 5 , cursor:"pointer"}} /></span>  :  <span onClick={()=>errorMsg("Please Login Before")} >  <i className=" fa fa-heart" style={{fontSize: 35,color:"#27ae60", paddingRight: 22, paddingTop: 5 , cursor:"pointer"}} /></span> }
                     ...
                     (
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          brokerRequest(property._id,4,property.userid);
                          setcontacted(true);
                           setShowUser(true)
                           getUserInfo(property._id)
