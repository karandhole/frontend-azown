  ...
  Save Changes
          ...
          <div className="list_view_flex">										
              ...
              <div className="listing-short-detail-wrap">
                <div className="_card_list_flex mb-2">
                  ...
                  <div className="_card_flex_last">
                    <h6 className="cms_amount mb-0 ">₹{property.cs_resale_details_exp_price}</h6>
                  </div> 
                </div>
              </div>
            </div>
            <div style={{borderTop: '#dddddd solid', borderBottom: '#dddddd solid', paddingBottom: 10}}>
              ...
              <div className="_card_list_flex mb-2">
                <p style={{lineHeight:'1'}}><i className="lni-map-marker" />{property.cs_location_city}</p>
              </div>											
            ...
            <div className="listing-detail-footer" style={{marginTop: 0, paddingRight: 0}}>
              ...
              {localStorage.getItem('userDetail') ? property.like && property.like.includes(userId) || liked ? <span  >  <i className=" fa fa-heart" style={{fontSize: 35,color:"red", paddingRight: 22, paddingTop: 5 , cursor:"pointer"}} /></span> :<span onClick={()=>{setliked(true);likeprop(property._id,6)}} >  <i className=" fa fa-heart" style={{fontSize: 35,color:`${ !liked ? "#27ae60":"red"}`, paddingRight: 22, paddingTop: 5 , cursor:"pointer"}} /></span>  :  <span onClick={()=>errorMsg("Please Login Before")} >  <i className=" fa fa-heart" style={{fontSize: 35,color:"#27ae60", paddingRight: 22, paddingTop: 5 , cursor:"pointer"}} /></span> }
                     ...
                     (
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          brokerRequest(property._id,6,property.userid);
                          setcontacted(true);
                           setShowUser(true)
                           getUserInfo(property._id)
