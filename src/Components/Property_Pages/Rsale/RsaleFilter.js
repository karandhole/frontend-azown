...
const RsaleFilter = ({handleFilter}) => {
        ...
        <div className="sidebar-widgets p-4">
          ...
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12 pt-4">
              ...
              <ul className="row p-0 m-0">
                <li className="col-lg-6 col-md-6 p-0">
                  <input id="a-15" className="checkbox-custom" name="Vitrified Tiles" checked={filterValues.floorType.includes("Vitrified Tiles")} onChange={handleFloorTypeChange} value="Vitrified Tiles" type="checkbox" />
                  <label htmlFor="a-15" className="checkbox-custom-label">Vitrified Tiles</label>
                </li>
                <li className="col-lg-6 col-md-6 p-0">
                  <input id="a-16" className="checkbox-custom" name="Mossaic" checked={filterValues.floorType.includes("Mossaic")} onChange={handleFloorTypeChange} value="Mossaic" type="checkbox" />
                  <label htmlFor="a-16" className="checkbox-custom-label">Mossaic</label>
                </li>
                <li className="col-lg-6 col-md-6 p-0">
                  <input id="a-17" className="checkbox-custom" name="Marble" checked={filterValues.floorType.includes("Marble")} onChange={handleFloorTypeChange} value="Marble" type="checkbox" />
                  <label htmlFor="a-17" className="checkbox-custom-label">Marble</label>
                </li>
                <li className="col-lg-6 col-md-6 p-0">
                  <input id="a-18" className="checkbox-custom" name="Granite" checked={filterValues.floorType.includes("Granite")} onChange={handleFloorTypeChange} value="Granite" type="checkbox" />
                  <label htmlFor="a-18" className="checkbox-custom-label">Granite</label>
                </li>
                <li className="col-lg-6 col-md-6 p-0">
                  <input id="a-19" className="checkbox-custom" name="Wooden" checked={filterValues.floorType.includes("Wooden")} onChange={handleFloorTypeChange} value="Wooden" type="checkbox" />
                  <label htmlFor="a-19" className="checkbox-custom-label">Wooden</label>
                </li>
                <li className="col-lg-6 col-md-6 p-0">
                  <input id="a-20" className="checkbox-custom" name="Cement" checked={filterValues.floorType.includes("Cement")} onChange={handleFloorTypeChange} value="Cement" type="checkbox" />
          ...
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12 pt-4 pb-4">
              ...
              <input type="range" className="w-100" min="0" max="50000" value={filterValues.range} onChange={handleSliderChange} name="my_range"  />
          ...
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12 pt-4">
              ...
              <ul className="row p-0 m-0">
                <li className="col-lg-6 col-md-6 p-0">
                  <input id="a-24" className="checkbox-custom" name="Car" checked={filterValues.park.includes("Car")} onChange={handleParkChange} value="Car" type="checkbox" />
                  <label htmlFor="a-24" className="checkbox-custom-label">Car</label>
                </li>
                <li className="col-lg-6 col-md-6 p-0">
                  <input id="a-25" className="checkbox-custom" name="Bike" checked={filterValues.park.includes("Bike")} onChange={handleParkChange} value="Bike" type="checkbox" />
                  <label htmlFor="a-25" className="checkbox-custom-label">Bike</label>
                </li>
                <li className="col-lg-6 col-md-6 p-0">
                  <input id="a-26" className="checkbox-custom" name="None" checked={filterValues.park.includes("None")} onChange={handleParkChange} value="None" type="checkbox" />
                  <label htmlFor="a-26" className="checkbox-custom-label">None</label>
                </li>
                <li className="col-lg-6 col-md-6 p-0">
                  <input id="a-27" className="checkbox-custom" name="Both" checked={filterValues.park.includes("Both")} onChange={handleParkChange} value="Both" type="checkbox" />
