          ...
          <div className="frm_submit_block">
            ...
            <div className="frm_submit_wrap">
              <div className="form-row p-2">
                ...
                <div className="form-group col-md-4" style={{marginTop:'2.5rem'}}>
                  <ul className=" ">
                    <li>
            ...
            <div className="o-features">
              <ul className="no-ul-list pl-4 third-row">
                ...
                <li>
                  ...
                  <label htmlFor="a-101" className="checkbox-custom-label">No Guardian</label>
                </li>
                <li>
      ...
      <section className='gray'>
        <div className="container">
          <div className="row justify-content-md-center bg-white">
                ...
                <Formik
                  ...
                  onSubmit={(values, { setSubmitting, setFieldValue, setTouched }) => {
                    if (currentStep === 1) {
                      ...
                      axios.put(`${host}/property/update-rpg/${rpgdata._id}/1`, formData, {
                        headers: {
            ...
            {rpgdata && <IsPremium propId={rpgdata._id} ownerId={rpgdata.userid} expDate={rpgdata.primium_expiry_date} propType={3} />}
            </div>
          </div>
        </div>
        {rpgdata && <PropertyTemplates id={rpgdata._id} />}
