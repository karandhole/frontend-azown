...
const ResidentialFlatmates = () => {
  ...
  const Schema = [ Yup.object().shape({
    rfm_detail_app_type: Yup.string().required('Required'),
    rfm_detail_bhk_type: Yup.string().required('Required'),
    rfm_detail_floor: Yup.number().required('Required').positive("Please Enter Positive Value"),
    rfm_detail_total_floor: Yup.string().required('Required'),
    rfm_detail_prop_age: Yup.string().required(' Required'),
    rfm_detail_facing: Yup.string().required(' Required'),
    rfm_detail_room_type: Yup.string().required(' Required'),
    rfm_detail_tenent_type: Yup.string().required('Required'),
    rfm_detail_builtup_area: Yup.number().required('Required').positive("Please Enter Positive Value"),
    rfm_detail_furnishing: Yup.string().required('Required'),
    rfm_detail_parking: Yup.string().required('Required'),
    rfm_detail_bathroom: Yup.number().required('Required').positive("Please Enter Positive Value"),
    rfm_detail_balcony: Yup.number().required('Required').positive("Please Enter Positive Value"),
    rfm_detail_water_supply: Yup.string().required(' Required'),
                ...
                <Formik
                  ...
                  onSubmit={(values, { setSubmitting, setTouched, setFieldValue }) => {
                    if (currentStep === 1) {
                      ...
                      setShowLoader(true)
                      axios.post(`${host}/property/add-rfm-prop`, formData, {
                        headers: {
