...
const Builder = () => {
  ...
  const { allUserData, alluserData, setallUserData } = userContext;
          ...
          <div className="_prt_filt_dash">
            ...
            <div className="_prt_filt_dash_last m2_hide">
              ...
              <div className="_prt_filt_add_new">
                <a href="submit-property-dashboard.html" className="prt_submit_link"><i className="fas fa-plus-circle" /><span className="d-none d-lg-block d-md-block">Create Builder</span></a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="table-responsive">
             ...
             {alluserData.map((user)=>{
                 ...
                 {/* <td className="m2_hide">
                   <div className="_leads_view"><h5 className="up">{user.usertype === 3 ? 'Builder' : user.usertype}</h5></div>
