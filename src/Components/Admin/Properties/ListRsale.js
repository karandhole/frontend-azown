                      ...
                      return <>
                        <tr>
                          <td>
                            <div className="dash_prt_wrap">
                              ...
                              <div className="dash_prt_caption">
                                <Link to={`/rsale-detail/${item._id}`}><h5>{`${item.rrs_detail_title && item.rrs_detail_title.slice(0,40)}...`}</h5></Link>
                          ...
                          <td className="m2_hide">
                            <div className="prt_leads"><span><button onClick={() => { setmodel(true); ownerlead(item.userid,item._id,1);console.log(item._id) }} className='btn btn-light p-2 btn-success'>{item.lead && item.lead.length} till now</button></span></div>
